        ...
        <div class="bg-gray-100 flex rounded-2xl shadow-xl max-w-3xl">
            ...
            <div class="sm:w-1/2 px-16 p-5">
                ...
                <form action="" class="flex flex-col gap-4 " @submit.prevent="login">
                    <input v-model="username" class="p-2 mt-8 rounded-xl border" type="text" name="username" placeholder="Username">
                    <div class="relative">
                        <input class="p-2 rounded-xl border w-full" type="password" v-model="password"
                        name="password" placeholder="Passworld">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray" class="bi bi-eye absolute top-1/2 right-0 -translate-y-1/2 right-4" viewBox="0 0 16 16">
